...
import com.example.budgetcatalog.R;
...
//ищем наши компоненты - списки вывода
    ...
    private void loadData(String strLike)
    {
        try {
            ...
            if (strLike == null || strLike.equals(""))
                cr = db.query("select _id, наименование, дата, описание, дата||', '||ifnull(описание,' ') as param2 from 'План'");
            else
                cr = db.query("select _id, наименование, дата, описание, дата||', '||ifnull(описание,' ') as param2 from " +
                              "'План' where наименование LIKE '%\"+strLike+\"%'\"");
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        switch (item.getItemId())
        {
            ...
            case 2:
                ...
                Intent intent = new Intent(MainActivity.this, AddEditBudget.class);
                intent.putExtra("mode", "edit");
                //получаем необходимые данные из курсора
                id = cr.getString(cr.getColumnIndexOrThrow("_id"));
                String name = cr.getString(cr.getColumnIndexOrThrow("наименование"));
                String address = cr.getString(cr.getColumnIndexOrThrow("дата"));
            ...
            case 3:
                if (!db.sqlExec("delete from План where _id="+id)) {
    ...
    public void onClickBtn(View v) {
        ...
        {
            Intent intentAddEdit = new Intent(MainActivity.this, AddEditBudget.class);
